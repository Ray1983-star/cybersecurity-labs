...
### ADCS Escalation Paths (ESC1 + ESC4)

![ADCS Escalations](images/11_10_adcs_escalations.png)

BloodHound identified 3 ADCS escalation paths targeting Domain Admins, Enterprise Admins, and the Domain Controller directly.

![ADCS Edge Detail](images/11_11_adcs_esc1_esc4.png)

ESC1 and ESC4 edge types confirmed — certificate abuse paths lead directly to Domain Admin without requiring the Administrator password.
...
### Administrator Session on Domain Controller
...
![DCSync Rights](images/11_15_dcsync_rights.png)

Multiple groups confirmed with DCSync rights against MARVEL.LOCAL.
