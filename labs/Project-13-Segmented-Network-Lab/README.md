...
<br>**Figure 13.10** — ARP scan from Kali Linux confirming active hosts on the DMZ network including pfSense and DC:1.
...
<br>**Figure 13.16** — Applied WAN firewall rule confirming DC:1 has TCP access to the internal network. This misconfigured rule is intentionally retained as the starting point for future exploitation exercises.
